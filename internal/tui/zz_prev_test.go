...
func TestPrevFlow(t *testing.T) {
	...
	rows := []Row{
		{Name: "JohnStarlight/ascii-art-web", SourcePrivate: true, Private: true, Target: "ascii-art-web"},
		{Name: "JohnStarlight/lem-in", SourcePrivate: true, Private: true, Target: "lem-in"},
	}
	...
	frame("── ΒΗΜΑ 2 · η οθόνη της μετακίνησης, με redact ενεργό ──",
		m.View("gitea.zone01.gr  ->  github.com/JohnStarlight"))
	...
	r.SetSize(94, 16)
	frame("── ΒΗΜΑ 4 · η οθόνη επανασύνδεσης ──", r.View("github.com/JohnStarlight"))
}
